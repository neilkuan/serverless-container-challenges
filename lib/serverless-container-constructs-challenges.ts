...
export interface ServerlessContainerChallengesConstructsStackProp extends cdk.StackProps {
...
export class ServerlessContainerConstructsChallengesStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: ServerlessContainerChallengesConstructsStackProp) {
